...
const Loader: React.FC = () => {
    return (
        <div className="absolute inset-0 bg-gray-900/80 backdrop-blur-sm flex flex-col items-center justify-center z-20">
            ...
            <h2 className="text-xl font-semibold text-white">Analyzing Your Data...</h2>
            <p className="text-gray-300 mt-1">The AI is building your mind map. This might take a moment.</p>
        </div>
    );
};
